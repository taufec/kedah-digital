...
export function Wordmark({ className = "" }: { className?: string }) {
  return (
    <a href="#top" className={`group flex items-center gap-2.5 ${className}`}>
      <span className="relative grid h-9 w-9 place-items-center overflow-hidden rounded-md bg-foreground/[0.06] ring-1 ring-foreground/10 transition-all group-hover:ring-primary/40">
        <img src={gamma.logo} alt="Kedah Tech Valley" className="h-7 w-7 object-contain dark:invert" />
